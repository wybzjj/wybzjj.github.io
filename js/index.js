			...
			var s = setInterval(function() {
			    ...
			    $('.info_my img').attr('src', "img/" + Math.floor(Math.random() * 23 + 1) + ".jpg")
			    $('.show_info').show();
			    ...
			    setTimeout(function() {
			        ...
			        // img.setAttribute('src', 'https://img1.baidu.com/it/u=4152707902,2307323591&fm=253&fmt=auto&app=138&f=JPEG?w=750&h=500');
			        // img.setAttribute('src', 'https://img1.baidu.com/it/u=4152707902,2307323591&fm=253&fmt=auto&app=138&f=JPEG?w=750&h=500');
			...
			// for (var i = 0; i < 199; i++) {
			//     personArray.push({
			//         image: "https://img1.baidu.com/it/u=4152707902,2307323591&fm=253&fmt=auto&app=138&f=JPEG?w=750&h=500"
			//     });
			// }
			for (var i = 1; i <= 200; i++) {
			    personArray.push({
			        image: "img/" + Math.floor(Math.random() * 23 + 1) + ".jpg"
			    });
			}
